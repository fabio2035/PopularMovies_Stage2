...
import com.example.fbrigati.popularmovies_stage2.DetailFragment;
...
public class TrailerObjectAdapter extends CursorAdapter {
    ...
    public final String LOG_TAG = TrailerObjectAdapter.class.getSimpleName();
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        viewHolder.textHolder.setText(cursor.getString(DetailFragment.COL_TRLR_NAME));
